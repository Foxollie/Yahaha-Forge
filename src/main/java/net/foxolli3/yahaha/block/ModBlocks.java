...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> KOROK_SEED_BLOCK = registerBlock("korok_seed_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).sound(SoundType.METAL)));
    public static final RegistryObject<Block> FIERY_KOROK_BLOCK = registerBlock("fiery_korok_block",
            () -> new SlimeBlock(BlockBehaviour.Properties.copy(Blocks.SLIME_BLOCK).sound(SoundType.HONEY_BLOCK).noOcclusion().lightLevel(p_50872_ -> 8)));
    public static final RegistryObject<Block> ICY_KOROK_BLOCK = registerBlock("icy_korok_block",
            () -> new SlimeBlock(BlockBehaviour.Properties.copy(Blocks.SLIME_BLOCK).sound(SoundType.HONEY_BLOCK).noOcclusion().lightLevel(p_50872_ -> 2)));
    public static final RegistryObject<Block> ELECTRIC_KOROK_BLOCK = registerBlock("electric_korok_block",
            () -> new SlimeBlock(BlockBehaviour.Properties.copy(Blocks.SLIME_BLOCK).sound(SoundType.HONEY_BLOCK).noOcclusion().lightLevel(p_50872_ -> 6)));
    public static final RegistryObject<Block> WATERY_KOROK_BLOCK = registerBlock("watery_korok_block",
            () -> new SlimeBlock(BlockBehaviour.Properties.copy(Blocks.SLIME_BLOCK).sound(SoundType.HONEY_BLOCK).noOcclusion().lightLevel(p_50872_ -> 4)));
    ...
    public static final RegistryObject<Block> KOROK_SEED_TILE_STAIRS = registerBlock("korok_seed_tile_stairs",
            () -> new StairBlock(ModBlocks.KOROK_SEED_TILES.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).sound(SoundType.METAL)));
    public static final RegistryObject<Block> KOROK_SEED_TILE_SLAB = registerBlock("korok_seed_tile_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).sound(SoundType.METAL)));

    public static final RegistryObject<Block> WAND_CONSTRUCTION_TABLE = registerBlock("wand_construction_table",
            () -> new WandConstructionTable(BlockBehaviour.Properties.copy(Blocks.SPRUCE_WOOD).noOcclusion()));
