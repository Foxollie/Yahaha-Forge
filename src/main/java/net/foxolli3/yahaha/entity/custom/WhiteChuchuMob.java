...
public class WhiteChuchuMob extends Monster implements GeoEntity {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        controllerRegistrar.add(new AnimationController<>(this,"controller",0,this::pWhiteicate));
        controllerRegistrar.add(new AnimationController<>(this, "spawnController", 0, this::spawnPWhiteicate));
    }

    private PlayState spawnPWhiteicate(AnimationState<WhiteChuchuMob> WhiteChuchuMobAnimationState) {
    ...
    private <T extends GeoAnimatable> PlayState pWhiteicate(AnimationState<T> tAnimationState) {
